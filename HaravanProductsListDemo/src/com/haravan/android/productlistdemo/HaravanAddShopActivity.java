...
public class HaravanAddShopActivity extends Activity implements OnClickListener{
	...
	protected Credential makeEmptyCredential(String shopname) {
		String apiKey = getString(R.string.haravan_api_key);
		String sekret = getString(R.string.haravan_shared_secret);
