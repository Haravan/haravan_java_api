...
import com.haravan.api.endpoints.API.APIResponseContent;
...
public class APITest extends AndroidTestCase {
	private class MockAPI extends API {
		...
		@Override
		public List<HaravanResource> findByQuery(
	...
	public void testConstructApiUri() {
		String expected = "http://some-shop.myharavan.com/admin/mock";
	...
	public void testConstructApiUri_argsNeedUrlEncoding() {
		String expected = "http://some-shop.myharavan.com/admin/mock.json?email=email%40isdandy.com&this=is+a+space";
		HashMap<String, String> params = new HashMap<String, String>(){{
			put("this", "is a space");
