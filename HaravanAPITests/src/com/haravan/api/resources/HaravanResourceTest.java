...
public class HaravanResourceTest extends AndroidTestCase {
	private class SomeHaravanResource extends HaravanResource {
		public void setAttribute(String name, String value) {
			super.setAttribute(name, value);
		}
	}

	private SomeHaravanResource resource;

	public void setUp() throws Exception {
		super.setUp();
		resource = new SomeHaravanResource();
