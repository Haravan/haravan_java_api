...
public abstract class API {
	private static final String MY_SHOPIFY_COM_ADMIN = ".myharavan.com/admin/";
	...
	public abstract List<HaravanResource> getAll();
	public abstract HaravanResource findById(int id);
	public abstract List<HaravanResource> findByQuery(HashMap<String, String> queryParams);
