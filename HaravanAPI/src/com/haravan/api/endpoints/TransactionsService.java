...
import com.haravan.api.handlers.HaravanResponseHandler;
import com.haravan.api.resources.Transaction;

@EndPoint("")
@ContextPath("/admin/orders/")
@ResponseHandler(HaravanResponseHandler.class)
public interface TransactionsService extends BaseHaravanService {
    ...
    /*
     * According to Haravan API Documentation PUT and DELETE aren't supported
    ...
    /**
     * @deprecated
     * This action is currently not supported by the Haravan API 
     */
    @Path("{0}/transactions/{1}.json")
    @HttpMethod(PUT)
