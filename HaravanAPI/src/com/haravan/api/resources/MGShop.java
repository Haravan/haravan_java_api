...
public class MGShop extends HaravanResource {
	...
	@JsonProperty("myharavan_domain")
	public String getMyharavanDomain() {
		return (String)getAttribute("myharavan_domain");
	}
	@JsonProperty("myharavan_domain")
	public void setMyharavanDomain(String _myharavan_domain) {
		setAttribute("myharavan_domain", _myharavan_domain);
	}
