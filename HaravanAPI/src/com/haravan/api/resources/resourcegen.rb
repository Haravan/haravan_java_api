...
fixtures_root = repo_root + "/HaravanAPITests/assets/fixtures"
...
import #{mainPackage}.handlers.HaravanResponseHandler;
...
public interface #{pluralized}Service extends BaseHaravanService {
...
def generate_resource(name, data)
  ...
  generate_java(gen_file, "HaravanResource", data, output)
  output.flush()
  output.close()
